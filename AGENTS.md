...
When “Gentle rides only” is selected, never recommend a park unless its listed matching rides include a gentle option, and never present thrill rides as the reason for that match.
